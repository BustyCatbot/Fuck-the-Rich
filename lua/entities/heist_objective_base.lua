...
ENT.PrintName		= "Objective Base"
ENT.Category		= "Heist Objective"
ENT.Spawnable		= true
...
if SERVER then
	...
	function ENT:Initialize()
		...
		self:SetNWString("HeistObjectPlaceText", HeistGetObject(self.ObjectType, self.Object)["placetext"])
		self:SetNWString("HeistObjectPlacingText", HeistGetObject(self.ObjectType, self.Object)["placingtext"])
		self:SetNWString("HeistObjectFixText", HeistGetObject(self.ObjectType, self.Object)["fixtext"])
		self:SetNWString("HeistObjectFixingText", HeistGetObject(self.ObjectType, self.Object)["fixingtext"])
